# Django settings for adhoc project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dummy_local_adhoc_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '04!sidr6vb-(d29c_f8rm#-grnhe0+y850&c3enu1oa0280#*+'
...
MIDDLEWARE_CLASSES = (
    # Uncomment this to see the toolbar in debug mode
...
# explicitly set our own debug toolbar settings
DEBUG_TOOLBAR_PATCH_SETTINGS = False

# this lets everyone see the debug toolbar .. obviously not ideal
